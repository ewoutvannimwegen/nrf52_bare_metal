...
volatile static const uint8_t uart_tx_buf[] = {'H', 'e', 'l', 'l', 'o', ',', 'w', 'o', 'r', 'l', 'd', '!', '\r', '\n'};
...
{
    NRF_UARTE0->TXD.PTR = (uint32_t)&uart_tx_buf[0];
    NRF_UARTE0->TXD.MAXCNT = sizeof(uart_tx_buf);
}
...
int main(void)
{
    ...
    NVIC_SetPriority(GPIOTE_IRQn, 8);
    ...
    i2c_write(TWIM1_BUS, LIS_REG_CTRL3_ADDR,
              (LIS_REG_CTRL3_I1_OVERRUN_En << LIS_REG_CTRL3_I1_OVERRUN_Pos) |
                  (LIS_REG_CTRL3_I1_WTM_En << LIS_REG_CTRL3_I1_WTM_Pos));
    i2c_write(TWIM1_BUS, LIS_REG_FIFO_CTRL_ADDR,
              (LIS_REG_FIFO_CTRL_FM_STREAM << LIS_REG_FIFO_CTRL_FM_Pos) |
                  (LIS2DH12_FIFO_LEN << LIS_REG_FIFO_CTRL_FTH_Pos));
    i2c_write(TWIM1_BUS, LIS_REG_FIFO_SRC_ADDR,
              (LIS_REG_FIFO_SRC_WTM_Enable << LIS_REG_FIFO_SRC_WTM_Pos) |
                  (LIS_REG_FIFO_SRC_OVRN_FIFO_Enable << LIS_REG_FIFO_SRC_OVRN_FIFO_Pos) |
                  (LIS_REG_FIFO_SRC_EMPTY_Enable << LIS_REG_FIFO_SRC_EMPTY_Pos));
    ...
    i2c_write(TWIM1_BUS, LIS_REG_CTRL1_ADDR,
